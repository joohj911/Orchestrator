...
for split in [I1,I2,I3]:
 for model in [파일럿 통과 모델]:
  for K in [5,10,20,50]:
   ...
   dense_single, dense_multi,          # bm25 제외 (2026-07 사용자 결정)
...
- **표2 방법 비교**: 행 {dense_single,dense_multi,fusion_add,fusion_mult}×split, 열 Recall_all@K(K별)/func_acc/completeness.
